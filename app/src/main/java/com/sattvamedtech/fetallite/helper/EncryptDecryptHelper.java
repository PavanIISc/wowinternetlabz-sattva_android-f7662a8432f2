...
public class EncryptDecryptHelper {
    ...
    private static final String cryptoPass = "fetalLife";
    ...
    public static String encryptIt(String value) {
        try {
            ...
            Logger.logDebug("encryptIt", "encryptedValue: " + encryptedValue);
    ...
    public static String decryptIt(String value) {
        try {
            ...
            Logger.logDebug("decryptIt", "decryptedValue: " + decryptedValue);
